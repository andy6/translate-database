...
--comment Creates a new table 'main.t_address' in the current database.

-- Table main.t_address
-- DROP TABLE IF EXISTS main.t_address CASCADE;
CREATE TABLE IF NOT EXISTS main.t_address (
