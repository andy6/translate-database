...
REM
echo Installing database... & @call ../liquibase/liquibase.bat --changeLogFile=install/install.xml --defaultsFile=liquibase.properties validate clearCheckSums update && echo Database was successfully installed. & echo.
